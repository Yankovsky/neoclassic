...
exports.all = function(callback) {
  db.query({
    name: 'get_all_news',
    text: 'SELECT id, slug, html, title, short_text AS "shortText", datetime FROM news'
  }, callback)
}
...
exports.get = function(id, callback) {
  db.single({
    name: 'get_news_by_id',
    text: 'SELECT id, slug, html, title, short_text AS "shortText", datetime FROM news WHERE id = $1',
    values: [id]
  }, callback)
}
