...
exports.allOfType = function(type, callback) {
  db.query({
    ...
    text: 'SELECT id, slug, title, html, short_text AS "shortText", EXTRACT(epoch FROM datetime) * 1000 AS "datetime", thumbnail_url AS "thumbnailUrl", type FROM entries WHERE type = $1',
    values: [type]
  }, callback)
}
