...
var s3 = new AWS.S3()
var S3_BUCKET = process.env.S3_BUCKET || 'neoclassic-dev'

//putPublicImageToBucket('slides/slide1.jpg', bucketName, 'slides/slide1.jpg')

function putPublicImageToBucket(fileName, bucket, key) {
