...
tinymce.PluginManager.add("advlist", function(e) {
    ...
    i = t("OL", e.getParam("advlist_number_styles", "default,lower-alpha,lower-greek,lower-roman,upper-alpha,upper-roman")), o = t("UL", e.getParam("advlist_bullet_styles", "default,circle,disc,square")), e.addButton("numlist", {
        ...
        type: "splitbutton", tooltip: "Bullet list", menu: o, onshow: r, onselect: function(e) {
...
tinymce.PluginManager.add("fullscreen", function(e) {
    ...
    return e.settings.inline ? void 0 : (e.on("init", function() {
        ...
        tooltip: "Fullscreen", shortcut: "Ctrl+Alt+F", onClick: n, onPostRender: function() {
            var t = this;
            e.on("FullscreenStateChanged", function(e) {
                t.active(e.state)
            })
    ...
    e.on("ResolveName", function(e) {
        ...
        tinymce.each("webkitallowfullscreen mozallowfullscreen allowfullscreen".split(" "), function(e) {
            ...
            for (var i, r, o, a, c, s, n, m = e.length; m--;) {
                for (i = e[m], n = i.attr(t), r = new tinymce.html.Node(n, 1), "audio" != n && "script" != n && r.attr({
                    width: i.attr("width"),
...
tinymce.PluginManager.add("noneditable", function(e) {
    ...
    function r() {
        ...
        function i(n, r) {
            var a, i;
            return "false" === t(n) && u.isBlock(n) ? (s.select(n), void 0) : (i = u.createRng(), "true" === t(n) && (n.firstChild || n.appendChild(e.getDoc().createTextNode(" ")), n = n.firstChild, r = !0), a = u.create("span", {
                id: g,
                "data-mce-bogus": !0
            ...
            if (v = s.getStart(), E = s.getEnd(), m = n(v) || n(E), m && (112 > h || h > 124) && h != c.DELETE && h != c.BACKSPACE) {
                ...
                if (p = r(v)) {
                    if (h == c.LEFT || h == c.BACKSPACE)if (m = i(p, !0), m && "false" === t(m)) {
                        if (a.preventDefault(), h != c.LEFT)return u.remove(m), void 0;
                        d(m, !0)
                    } else o(p);
                    if (h == c.RIGHT || h == c.DELETE)if (m = i(p), m && "false" === t(m)) {
                        if (a.preventDefault(), h != c.RIGHT)return u.remove(m), void 0;
                        d(m, !1)
                    } else o(p)
                }
...
tinymce.PluginManager.add("print", function(e) {
    e.addCommand("mcePrint", function() {
        ...
        title: "Print",
        cmd: "mcePrint"
    }), e.addShortcut("Ctrl+P", "", "mcePrint"), e.addMenuItem("print", {
        text: "Print",
        cmd: "mcePrint",
        icon: "print",
        shortcut: "Ctrl+P",
...
tinymce.PluginManager.add("save", function(e) {
    ...
    function n() {
        ...
        return e.getParam("save_oncancelcallback") ? (e.execCallback("save_oncancelcallback", e), void 0) : (e.setContent(a), e.undoManager.clear(), e.nodeChanged(), void 0)
    }
...
!function(e, t) {
    ...
    var s = {}, l = "tinymce/spellcheckerplugin/DomTextMatcher", c = "tinymce/spellcheckerplugin/Plugin", d = "tinymce/PluginManager", u = "tinymce/util/Tools", f = "tinymce/ui/Menu", p = "tinymce/dom/DOMUtils", m = "tinymce/util/XHR", h = "tinymce/util/URI", g = "tinymce/util/JSON";
    r(l, [], function() {
        return function(e, t) {
            function n(e, t) {
            ...
            function r(e) {
                var t;
                if (3 === e.nodeType)return e.data;
                if (E[e.nodeName] && !N[e.nodeName])return "";
                if (t = "", (N[e.nodeName] || k[e.nodeName]) && (t += "\n"), e = e.firstChild)do t += r(e); while (e = e.nextSibling);
                return t
            }

            function i(e, t, n) {
                var r, i, o, a, s = [], l = 0, c = e, d, u = 0;
                t = t.slice(0), t.sort(function(e, t) {
                    return e.start - t.start
                }), d = t.shift();
                e:for (; ;) {
                    if ((N[c.nodeName] || k[c.nodeName]) && l++, 3 === c.nodeType && (!i && c.length + l >= d.end ? (i = c, a = d.end - l) : r && s.push(c), !r && c.length + l > d.start && (r = c, o = d.start - l), l += c.length), r && i) {
                        if (c = n({
                                startNode: r,
                                startNodeIndex: o,
                                endNode: i,
                        ...
                        if ((!E[c.nodeName] || N[c.nodeName]) && c.firstChild) {
                            c = c.firstChild;
                            continue
                        }
                        if (c.nextSibling) {
            ...
            var C, x = [], w, _ = t.dom, N, E, k;
            return N = t.schema.getBlockElements(), E = t.schema.getWhiteSpaceElements(), k = t.schema.getShortEndedElements(), w = r(e), {
                text: w,
                matches: x,
                each: d,
                filter: c,
        ...
        t.add("spellchecker", function(t, l) {
            ...
            function f(e, o) {
                ...
                n.each(s, function(e) {
                    a.push({
                        text: e, onclick: function() {
                            t.insertContent(t.dom.encode(e)), t.dom.remove(o), h()
                        }
                    })
                }), a.push.apply(a, [{text: "-"}, {
                ...
                }), E.renderTo(document.body);
                var l = i.DOM.getPos(t.getContentAreaContainer()), c = t.dom.getPos(o[0]), d = t.dom.getRoot();
                "BODY" == d.nodeName ? (c.x -= d.ownerDocument.documentElement.scrollLeft || d.scrollLeft, c.y -= d.ownerDocument.documentElement.scrollTop || d.scrollTop) : (c.x -= d.scrollLeft, c.y -= d.scrollTop), l.x += c.x, l.y += c.y, E.moveTo(l.x, l.y + o[0].offsetHeight)
            }
            ...
            function m() {
                function e(e) {
                    return t.setProgressState(!1), u(e) ? (t.windowManager.alert("No misspellings found"), void(N = !1)) : (_ = e, c().find(p()).filter(function(t) {
                        return !!e[t.text]
                    }).wrap(function(e) {
                ...
                function r(e, t, r) {
                    o.send({
                        url: new a(l).toAbsolute(k.spellchecker_rpc_url),
                        type: "post",
                        content_type: "application/x-www-form-urlencoded",
                        data: "text=" + encodeURIComponent(t) + "&lang=" + k.spellchecker_language,
                        success: function(e) {
                            e = s.parse(e), e ? e.error ? n(e.error) : r(e.words) : n("Sever response wasn't proper JSON.")
                        },
                        error: function(e, t) {
                ...
                if (N)return void v();
                v(), N = !0, t.setProgressState(!0);
                var i = k.spellchecker_callback || r;
                i.call(w, "spellcheck", c().text, e, n), t.focus()
            }
            ...
            function v() {
                c().reset(), w.textMatcher = null, N && (N = !1, t.fire("SpellcheckEnd"))
            }
            ...
            function C(e) {
                var t = k.spellchecker_language;
                e.control.items().each(function(e) {
                    e.active(e.settings.data === t)
                })
            }

            var x, w = this, _, N, E, k = t.settings, S = k.spellchecker_languages || "English=en,Danish=da,Dutch=nl,Finnish=fi,French=fr_FR,German=de,Italian=it,Polish=pl,Portuguese=pt_BR,Spanish=es,Swedish=sv";
            x = d("Language", n.map(S.split(","), function(e) {
                var t = e.split("=");
            ...
            var T = {
                tooltip: "Spellcheck", onclick: m, onPostRender: function() {
                    var e = this;
                    t.on("SpellcheckStart SpellcheckEnd", function() {
                        e.active(N)
                    })
            ...
            x.length > 1 && (T.type = "splitbutton", T.menu = x, T.onshow = C, T.onselect = function(e) {
                k.spellchecker_language = e.control.settings.data
            }), t.addButton("spellchecker", T), t.addCommand("mceSpellCheck", m), t.on("remove", function() {
                E && (E.remove(), E = null)
            }), t.on("change", h), this.getTextMatcher = c, this.getWordCharPattern = p, this.getLanguage = function() {
                return k.spellchecker_language
            }, k.spellchecker_language = k.spellchecker_language || k.language || "en"
        })
    }), a([l, c])
}(this);
...
!function(e, t) {
    ...
    r(l, [c, d], function(e, n) {
        ...
        return function(o, a) {
            ...
            function u(e) {
                return e && (M.hasClass(e.elm, "mce-item-selected") || e == P)
            }
            ...
            function f() {
                ...
                return i(a.rows, function(t) {
                    i(t.cells, function(n) {
                        return M.hasClass(n, "mce-item-selected") || P && n == P.elm ? (e.push(t), !1) : void 0
                    })
                }), e
            }
            ...
            function m() {
                var e = M.createRng();
                e.setStartAfter(a), e.setEndAfter(a), L.setRng(e), M.remove(a)
            }
            ...
            function h() {
                ...
                }), 0 === M.select("tr", a).length ? (e.setStartBefore(a), e.setEndBefore(a), L.setRng(e), void M.remove(a)) : (i(M.select("thead,tbody,tfoot", a), function(e) {
                    0 === e.rows.length && M.remove(e)
                }), s(), void(B && (t = A[Math.min(A.length - 1, B.y)], t && (L.select(t[Math.min(t.length - 1, B.x)].elm, !0), L.collapse(!0)))))
            }
            ...
            function y(t, n, r) {
                ...
                if (t ? (o = S(t), a = o.x, l = o.y, f = a + (n - 1), m = l + (r - 1)) : (B = D = null, i(A, function(e, t) {
                        i(e, function(e, n) {
                            u(e) && (B || (B = {x: n, y: t}), D = {x: n, y: t})
                        })
                    }), B && (a = B.x, l = B.y, f = D.x, m = D.y)), y = c(a, l), b = c(f, m), y && b && y.part == b.part) {
            ...
            function R(e) {
                ...
                if (D = S(e), B && D) {
                    for (t = Math.min(B.x, D.x), n = Math.min(B.y, D.y), r = Math.max(B.x, D.x), i = Math.max(B.y, D.y), o = r, a = i, d = n; a >= d; d++)e = A[d][t], e.real || t - (e.colspan - 1) < t && (t -= e.colspan - 1);
            ...
            var A, B, D, P, L = o.selection, M = L.dom;
            a = a || M.getParent(L.getStart(), "table"), s(), P = M.getParent(L.getStart(), "th,td"), P && (B = S(P), D = T(), P = c(B.x, B.y)), e.extend(this, {
                deleteTable: m,
                split: v,
                merge: y,
                insertRow: b,
        ...
        function s(r) {
            ...
            function d() {
                var e = r.dom, t, n, c, d;
                t = e.getParent(r.selection.getStart(), "table"), d = {
                    ...
                    onsubmit: function() {
                        ...
                        r.undoManager.transact(function() {
                            t || (t = h(n.cols || 1, n.rows || 1)), r.dom.setAttribs(t, {
            ...
            function f() {
                var e = r.dom, t, n, o = [];
                o = r.dom.select("td.mce-item-selected,th.mce-item-selected"), t = r.dom.getParent(r.selection.getStart(), "td,th"), !o.length && t && o.push(t), t = t || o[0], t && (n = {
                    width: i(e.getStyle(t, "width") || e.getAttrib(t, "width")),
                    height: i(e.getStyle(t, "height") || e.getAttrib(t, "height")),
                        ...
                        r.undoManager.transact(function() {
                            l(o, function(n) {
                                r.dom.setAttrib(n, "scope", t.scope), r.dom.setStyles(n, {
                                    width: a(t.width),
                                    height: a(t.height)
                                }), t.type && n.nodeName.toLowerCase() != t.type && (n = e.rename(n, t.type)), s(n), t.align && r.formatter.apply("align" + t.align, {}, n), c(n), t.valign && r.formatter.apply("valign" + t.valign, {}, n)
                            }), r.focus()
                        })
                    }
                }))
            ...
            var x, w, _ = this;
            r.settings.table_grid === !1 ? r.addMenuItem("inserttable", {
                text: "Insert table",
                icon: "table",
                context: "table",
                onclick: d
                ...
                menu: [{
                    ...
                    onPostRender: y
                }, {text: "-"}, {text: "Cut row", onclick: p("mceTableCutRow"), onPostRender: y}, {
                    text: "Copy row",
...
tinymce.PluginManager.add("textcolor", function(e) {
    ...
    e.addButton("forecolor", {
        ...
        tooltip: "Text color",
        selectcmd: "ForeColor",
        panel: {role: "application", ariaRemember: !0, html: o, onclick: r},
        onclick: l
